...
namespace Dynastream.Fit
{
    ...
    public class MesgBroadcaster
    {
        ...
        public event MesgEventHandler TrainingSettingsMesgEvent;
        ...
        public event MesgEventHandler SplitSummaryMesgEvent;
        ...
        public event MesgEventHandler HsaBodyBatteryDataMesgEvent;
        
        public event MesgEventHandler HsaEventMesgEvent;
        
        public event MesgEventHandler HsaAccelerometerDataMesgEvent;
        
        public event MesgEventHandler HsaGyroscopeDataMesgEvent;
        
        public event MesgEventHandler HsaStepDataMesgEvent;
        
        public event MesgEventHandler HsaSpo2DataMesgEvent;
        
        public event MesgEventHandler HsaStressDataMesgEvent;
        
        public event MesgEventHandler HsaRespirationDataMesgEvent;
        
        public event MesgEventHandler HsaHeartRateDataMesgEvent;
        
        public event MesgEventHandler HsaConfigurationDataMesgEvent;
        
        public event MesgEventHandler HsaWristTemperatureDataMesgEvent;
        ...
        public event MesgEventHandler AadAccelFeaturesMesgEvent;
        ...
        public event MesgEventHandler RawBbiMesgEvent;
        
        public event MesgEventHandler RespirationRateMesgEvent;
        
        public event MesgEventHandler ChronoShotSessionMesgEvent;
        ...
        public void OnMesg(object sender, MesgEventArgs e)
        {
            ...
            case (ushort)MesgNum.TrainingSettings:
                if (TrainingSettingsMesgEvent != null)
                {
                    TrainingSettingsMesg trainingSettingsMesg = new TrainingSettingsMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = trainingSettingsMesg;
                    TrainingSettingsMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.SplitSummary:
                if (SplitSummaryMesgEvent != null)
                {
                    SplitSummaryMesg splitSummaryMesg = new SplitSummaryMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = splitSummaryMesg;
                    SplitSummaryMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.HsaBodyBatteryData:
                if (HsaBodyBatteryDataMesgEvent != null)
                {
                    HsaBodyBatteryDataMesg hsaBodyBatteryDataMesg = new HsaBodyBatteryDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaBodyBatteryDataMesg;
                    HsaBodyBatteryDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaEvent:
                if (HsaEventMesgEvent != null)
                {
                    HsaEventMesg hsaEventMesg = new HsaEventMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaEventMesg;
                    HsaEventMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaAccelerometerData:
                if (HsaAccelerometerDataMesgEvent != null)
                {
                    HsaAccelerometerDataMesg hsaAccelerometerDataMesg = new HsaAccelerometerDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaAccelerometerDataMesg;
                    HsaAccelerometerDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaGyroscopeData:
                if (HsaGyroscopeDataMesgEvent != null)
                {
                    HsaGyroscopeDataMesg hsaGyroscopeDataMesg = new HsaGyroscopeDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaGyroscopeDataMesg;
                    HsaGyroscopeDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaStepData:
                if (HsaStepDataMesgEvent != null)
                {
                    HsaStepDataMesg hsaStepDataMesg = new HsaStepDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaStepDataMesg;
                    HsaStepDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaSpo2Data:
                if (HsaSpo2DataMesgEvent != null)
                {
                    HsaSpo2DataMesg hsaSpo2DataMesg = new HsaSpo2DataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaSpo2DataMesg;
                    HsaSpo2DataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaStressData:
                if (HsaStressDataMesgEvent != null)
                {
                    HsaStressDataMesg hsaStressDataMesg = new HsaStressDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaStressDataMesg;
                    HsaStressDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaRespirationData:
                if (HsaRespirationDataMesgEvent != null)
                {
                    HsaRespirationDataMesg hsaRespirationDataMesg = new HsaRespirationDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaRespirationDataMesg;
                    HsaRespirationDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaHeartRateData:
                if (HsaHeartRateDataMesgEvent != null)
                {
                    HsaHeartRateDataMesg hsaHeartRateDataMesg = new HsaHeartRateDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaHeartRateDataMesg;
                    HsaHeartRateDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaConfigurationData:
                if (HsaConfigurationDataMesgEvent != null)
                {
                    HsaConfigurationDataMesg hsaConfigurationDataMesg = new HsaConfigurationDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaConfigurationDataMesg;
                    HsaConfigurationDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HsaWristTemperatureData:
                if (HsaWristTemperatureDataMesgEvent != null)
                {
                    HsaWristTemperatureDataMesg hsaWristTemperatureDataMesg = new HsaWristTemperatureDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hsaWristTemperatureDataMesg;
                    HsaWristTemperatureDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.AadAccelFeatures:
                if (AadAccelFeaturesMesgEvent != null)
                {
                    AadAccelFeaturesMesg aadAccelFeaturesMesg = new AadAccelFeaturesMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = aadAccelFeaturesMesg;
                    AadAccelFeaturesMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.RawBbi:
                if (RawBbiMesgEvent != null)
                {
                    RawBbiMesg rawBbiMesg = new RawBbiMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = rawBbiMesg;
                    RawBbiMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.ChronoShotSession:
                if (ChronoShotSessionMesgEvent != null)
                {
                    ChronoShotSessionMesg chronoShotSessionMesg = new ChronoShotSessionMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = chronoShotSessionMesg;
                    ChronoShotSessionMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.ChronoShotData:
                if (ChronoShotDataMesgEvent != null)
                {
                    ChronoShotDataMesg chronoShotDataMesg = new ChronoShotDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = chronoShotDataMesg;
                    ChronoShotDataMesgEvent(sender, mesgEventArgs);
                }
                break;
